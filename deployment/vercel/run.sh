#!/bin/bash
#
# Starts Example inside the Vercel container.
#
# Dockerfile.vercel installs the JARs under /opt/example with install-docker.sh.
...
INSTALL_HOME=/opt/example
APP_HOME=/tmp/example
